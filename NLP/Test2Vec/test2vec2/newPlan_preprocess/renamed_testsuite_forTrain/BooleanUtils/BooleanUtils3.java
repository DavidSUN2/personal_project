...
public class BooleanUtils3 {
    ...
    public void BooleanUtils() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "BooleanUtils3.test1501");
    ...
    public void BooleanUtils() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "BooleanUtils3.test1502");
    ...
    public void BooleanUtils() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "BooleanUtils3.test1503");
    ...
    public void BooleanUtils() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "BooleanUtils3.test1504");
    ...
    public void BooleanUtils() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "BooleanUtils3.test1505");
    ...
    public void BooleanUtils() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "BooleanUtils3.test1506");
        boolean[] booleanArray1 = new boolean[] { false };
        boolean boolean2 = org.apache.commons.lang3.BooleanUtils.and(booleanArray1);
