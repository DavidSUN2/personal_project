...
public class StrBuilder1 {
    ...
    public void StrBuilder() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "StrBuilder1.test501");
    ...
    public void StrBuilder() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "StrBuilder1.test502");
    ...
    public void StrBuilder() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "StrBuilder1.test503");
        org.apache.commons.lang3.text.StrBuilder strBuilder1 = new org.apache.commons.lang3.text.StrBuilder((-1));
    ...
    public void StrBuilder() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "StrBuilder1.test504");
        org.apache.commons.lang3.text.StrBuilder strBuilder1 = new org.apache.commons.lang3.text.StrBuilder("1");
    ...
    public void StrBuilder() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "StrBuilder1.test505");
        org.apache.commons.lang3.text.StrBuilder strBuilder0 = new org.apache.commons.lang3.text.StrBuilder();
