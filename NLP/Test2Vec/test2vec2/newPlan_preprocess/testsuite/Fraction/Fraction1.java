...
public class Fraction1 {
    ...
    @Test
    public void Fraction501() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "Fraction1.Fraction501");
    ...
    @Test
    public void Fraction502() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "Fraction1.Fraction502");
    ...
    @Test
    public void Fraction503() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "Fraction1.Fraction503");
    ...
    @Test
    public void Fraction504() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "Fraction1.Fraction504");
