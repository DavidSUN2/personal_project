...
public class LocaleUtils0 {
    ...
    @Test
    public void LocaleUtils01() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "LocaleUtils0.LocaleUtils01");
        // The following exception was thrown during execution in LocaleUtils generation
        try {
    ...
    @Test
    public void LocaleUtils02() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "LocaleUtils0.LocaleUtils02");
    ...
    @Test
    public void LocaleUtils03() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "LocaleUtils0.LocaleUtils03");
        // The following exception was thrown during execution in LocaleUtils generation
        try {
    ...
    @Test
    public void LocaleUtils04() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "LocaleUtils0.LocaleUtils04");
    ...
    @Test
    public void LocaleUtils05() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "LocaleUtils0.LocaleUtils05");
    ...
    @Test
    public void LocaleUtils06() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "LocaleUtils0.LocaleUtils06");
    ...
    @Test
    public void LocaleUtils07() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "LocaleUtils0.LocaleUtils07");
    ...
    @Test
    public void LocaleUtils08() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "LocaleUtils0.LocaleUtils08");
        java.util.Locale locale0 = null;
    ...
    @Test
    public void LocaleUtils09() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "LocaleUtils0.LocaleUtils09");
        java.util.Locale locale0 = null;
    ...
    @Test
    public void LocaleUtils10() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "LocaleUtils0.LocaleUtils10");
    ...
    @Test
    public void LocaleUtils11() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "LocaleUtils0.LocaleUtils11");
    ...
    @Test
    public void LocaleUtils12() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "LocaleUtils0.LocaleUtils12");
    ...
    @Test
    public void LocaleUtils13() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "LocaleUtils0.LocaleUtils13");
