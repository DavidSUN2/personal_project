...
def process_file(file_path, data_file_role, dataset_name, word_to_count, path_to_count, max_contexts):
    ...
    with open(output_path, 'w') as outfile:
        with open(file_path, 'r') as file:
            for line in file:
                ...
                if len(contexts) < min_unfiltered:
                    min_unfiltered = len(contexts)
    ...
    print('Total methods/examples: ' + str(total))
    print('Empty methods/examples: ' + str(empty))
    print('Max number of contexts per target: ' + str(max_unfiltered))
    print('Min number of contexts per target: ' + str(min_unfiltered))
    print('Methods/examples with at least one full found context: ' + str(sum_full_exist))
    print('Methods/examples with # full found contexts > max_contexts: ' + str(sum_full))
    print('Methods/examples with # full found contexts < max_contexts: ' + str(sum_partial1+sum_partial2+sum_less))
#    print('sum_partial2: ' + str(sum_partial2))
    return total
