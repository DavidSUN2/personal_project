...
public class FastDatePrinter0 {
    ...
    @Test
    public void FastDatePrinter() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "FastDatePrinter0.test1");
    ...
    public void FastDatePrinter() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "FastDatePrinter0.test2");
    ...
    public void FastDatePrinter() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "FastDatePrinter0.test3");
    ...
    public void FastDatePrinter() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "FastDatePrinter0.test4");
    ...
    public void FastDatePrinter() throws Throwable {
        if (debug)
            System.out.format("%n%s%n", "FastDatePrinter0.test5");
